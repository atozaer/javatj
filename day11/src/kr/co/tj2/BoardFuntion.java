...
public class BoardFuntion {
	...
	public void search(String searchTitle, Scanner scan, ArrayList<HashMap<String,String>> boardList) {
	...
	public void update(String updateTitle, Scanner scan, ArrayList<HashMap<String,String>> boardList, String updateYN, String titleContent, int indexI, String title, String content) {
		boolean result = false;
		HashMap<String, String> boardHash = null;
