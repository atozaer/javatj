						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<form id="frm-frid-id" action="idSearch.do" method="post">
									   * 이 름:<input type="text" name="mname"><br>
									   * 이메일:<input type="text" name="mmail"><br>
									   <ul class="actions" style="float: right;">
										   <li><input type="submit" value="아이디 찾기" class="primary"></li>
										   <li><input type="button" value="비밀번호 찾기" onclick="location.href='pwSearch.jsp'"></li>
									   </ul>
									</form>
								</section>
