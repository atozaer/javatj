						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<c:forEach var="rvo" items="${Search}">
										...
										<div class="col-4" style="justify-content:center;">
											...
											<table>
												<tr style="background: transparent; border: none; padding-bottom: 0px;">
													...
													<td colspan="2" style=" width:40%; text-align: right; padding-bottom: 0px;"> <ul id="rmenu${rvo.rnum}" class="actions"> <hc:reviewDelete mid="${rvo.mid}" rnum="${rvo.rnum}"></hc:reviewDelete></ul> </td>
												...
												<tr style="background: transparent; border: none;">
													<td colspan="3">
														<span class="image fit" style="width: 370px; height: 370px;">
